...
export const members = [
    ...
    <div>
        <div className="member">
            ...
            <p className="member-description">
                Son is dedicated to building out projects in Cosmos to solidify
                it as the go-to hub in the crypto world. He is a talented and
                eager blockchain engineer.
            </p>
        </div>
    </div>,
    <div>
        <div className="member">
            ...
            <p className="member-position">Blockchain Engineer</p>
            <p className="member-description">
                Vuong is a capable and diligent engineer who has increasingly
                shown excellence in developing projects in Cosmos.
            </p>
        </div>
    </div>,
    <div>
        <div className="member">
            ...
            <p className="member-description">
                Minh is responsible for Notional's server configurations with
                deep insight in Linux and creating all useful open-sourced tools
                to improve the Cosmos ecosystem.
            </p>
        </div>
    </div>,
    <div>
        <div className="member">
            ...
            <p className="member-description">
                Vinh is very talented in business development and management. He
                has made great progress in optimizing organization and
                efficiency within Notional.
            </p>
        </div>
    </div>,
    <div>
