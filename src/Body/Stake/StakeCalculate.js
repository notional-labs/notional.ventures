        ...
        <div className="calculate">
            ...
            <table className="reward-table">
                <tr>
                    ...
                    <td className="token">
                        {((value * annualProfit) / 100 / 365).toFixed(2)}{" "}
                        {props.denom}
                    </td>
                    <td className="usd">
                        $
                        {(((value * annualProfit) / 100 / 365) * price).toFixed(
                            2
                        )}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td className="token">
                        {((value * annualProfit) / 100 / 12).toFixed(2)}{" "}
                        {props.denom}
                    </td>
                    <td className="usd">
                        $
                        {(((value * annualProfit) / 100 / 12) * price).toFixed(
                            2
                        )}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td className="token">
                        {((value * annualProfit) / 100).toFixed(2)}{" "}
                        {props.denom}
                    </td>
                    <td className="usd">
