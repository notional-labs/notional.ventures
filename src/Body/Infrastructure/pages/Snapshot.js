        ...
        <div className="snapshot-section">
          ...
          <div className="snapshot-container">
            ...
            <p className="snapshot-text">
              Notional considerably improves the time it takes to re-sync nodes
              to the current block. We achieve this by creating various
              compressed archives that we deliver from high-performance
              services. The service is crucial for validators and other service
              providers who require fast deployments or quick recovery of
              existing services.
            </p>
